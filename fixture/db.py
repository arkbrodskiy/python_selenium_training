...
class DbFixture:
    ...
    def get_contact_list(self):
        ...
        try:
            ...
            for row in cursor:
                (id, first_name, last_name, address, email, email2, email3, home, mobile, work, phone2) = row
                result_list.append(Contact(id=str(id), first_name=first_name, last_name=last_name, address=address,
